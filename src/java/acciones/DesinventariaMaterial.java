...
/**
 * Este servlet desinventaria materiales de la tabla materiales de la base de datos
 * laboratorio o resta cantidad de un material ya registrado.
 * El servlet obtiene del objeto request los atributos de los material. 
 * El servlet verifica que los atributos de material sean válidas.
 * 
 * @author jesus
 */
public class DesinventariaMaterial extends HttpServlet {
...
//             Establece que la página siguiente es capturaProducto.jsp
            rd = request.getRequestDispatcher("capturaMaterialDesinventariar.jsp");
        } else {
...
//             Crea el objeto para acceder a la base de datos
    ...
    public String getServletInfo() {
        return "Servlet que desiventaria materiales";
    }// </editor-fold>
    }
