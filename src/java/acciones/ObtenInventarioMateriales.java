...
/**
 * Este servlet obtiene de la tabla materiales de la base de datos laboratorio, la
...
public class ObtenInventarioMateriales extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Obtiene la lista de materiales del catalogo de materiales
        ArrayList<Material> lista = fachada.consultarInventarioMateriales();
        ...
        Lista listaMateriales = new Lista("Lista de todos los materiales", lista);
        ...
        // del servidor
        session.setAttribute("listaMateriales", listaMateriales);
    ...
    */
    ...
    public String getServletInfo() {
        return "Servlet que obtiene la lista de materiales del catalogo de materiales";
    }// </editor-fold>
}
