...
/**
 * Este servlet agrega un producto a la tabla productos de la base de datos
...
public class AgregaProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        mensajes.putAll(validaciones.validaClaveProducto(request));
        ...
        if (!mensajes.isEmpty()) {
            ...
            rd = request.getRequestDispatcher("capturaProducto.jsp");
        } else {
    ...
    public String getServletInfo() {
        return "Servlet que agrega un producto al catalogo de producto";
    }// </editor-fold>
    }
